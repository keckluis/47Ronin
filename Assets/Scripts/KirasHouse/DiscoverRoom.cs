...
public class DiscoverRoom : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Destroy(copy.GetComponent<DiscoverRoom>());
    ...
    {
        Interacted = true;
        Player.GetComponent<PlayerActions_Level03>().TextBlack.GetComponent<TextMeshProUGUI>().text = text;
        Player.GetComponent<PlayerActions_Level03>().TextWhite.GetComponent<TextMeshProUGUI>().text = text;
    ...
    IEnumerator RemoveText()
    {
        ...
        Player.GetComponent<PlayerActions_Level03>().TextBlack.GetComponent<TextMeshProUGUI>().text = "";
        Player.GetComponent<PlayerActions_Level03>().TextWhite.GetComponent<TextMeshProUGUI>().text = "";
    }
